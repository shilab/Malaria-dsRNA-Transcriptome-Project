...
We can take the file “GO_EL_R” as an example to have a quick view of the GO analysis results. Each of the file includes 10 columns, which includes:
1.	GO term ID
2.	Description
...
To take the file “KEGG_EL” as an example to go through the KEGG analysis results. It can be found that it looked similar as GO results, which has the same 11 columns as the previous file.  
...
Results summary:
For the GO analysis, we found 397 GO terms for the condition comparison between Early and Late, 393 GO terms for the condition comparison between Early and Mid, and 395 GO terms for the condition comparison between Mid and Late. They are all listed in ascending order according to the value of p.adjust (or q-value).

For the KEGG analysis, we found 36 KEGG pathways for the condition comparison between Early and Late, 36 KEGG pathways for the condition comparison between Early and Mid, and also 36 KEGG pathways for the condition comparisons between Mid and Late. Same as Go analysis results, they are all listed in ascending order according to the p. adjust value (or q-value) as well. 
